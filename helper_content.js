...
export const application_content = {
    ...
    "1" : {
        ...
        content : helper_content["1"].heading,
    },
    "2" : {
...
export function clear_application(){
    //Clear the Heading
    document.querySelector('.title-content').textContent = '';
    //Clear the helper content
    document.querySelector('.pop-up-heading-text').textContent = '';
    //Clear the Helper content
    document.querySelector('.pop-up-content-text').textContent = '';
}
