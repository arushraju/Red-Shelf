...
function onGsapSelectionLocationShown(GSAP){
    ...
    document.querySelector('.search-shown-option-container').style.display = 'none'; //Floor Options Apppears //Floor options disappear
    console.log('Now this motherfucker must disappear');
