...
form.addEventListener('submit',async function (e){
    ...
    if(isNaN(ID)){
        ...
        //Check which subject does it match (This will make the bookshelf colored and will also update the legend of the bookshelf subjects). This will also update the UI and will also make the right gsap to lit up.
        loading_page.style.display = 'block';
        ...
        //Update the title
        document.querySelector('.title-content').innerHTML = 'Select the Bookshelf - [2.8]';
...
async function getSubjectBookshelf(subject_text){
    ...
    subjects = [];
    subject_colors = [];
    //Also clear the previous subjects from the subjects icons
    document.querySelector('.subjects-legend-flex').innerHTML = '';
...
function onGsapSelectionStart(GSAP){
    ...
    if(previuos_application_flow == 2.4){
        ...
        //Now if the selection is some thign then push that as the last obejct
    }
