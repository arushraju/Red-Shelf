...
form.addEventListener('submit',async function (e){
    ...
    //make all the booklshelfs other than the first floor to be 0.5
    //Add the ending location as the last object in the path array
    ...
    //console.log('Now the scale of the booklshelfs has turned into 0.5');
...
function animate() {
    ...
    //console.log(document.querySelector('.search-shown-option-container').style.display);
