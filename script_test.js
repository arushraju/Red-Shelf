...
import {application_content , clear_application , update_application } from "./helper_content.js";
...
// const url = "../Subject_Summary_1000.xlsx";
// let subject_list = [];
...
async function getTargetBookshelf(ID){
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        if (child.range_low <= ID && child.range_high >= ID  && (Number)(child.mesh_name) <= 54) {
            console.log(`%%%% Bookshelf mesh name: ${child.mesh_name} | Low Range is equal to ${child.range_low} and High Range is ${child.range_high} and ID is ${ID}`);
