...
form.addEventListener('submit',function (e){
    ...
    model.traverse((child) => {
        ...
        if (child.isMesh && (
            child.name == 'Cube003' ||
            child.name == 'Cube003_1' ||
            child.name == 'Cube003_2' ||
            child.name == 'Cube003_3' ||
            child.name == 'Cube003_4' ||
            child.name == 'Cube003_5' ||
            child.name == 'Cube003_6' ||
            child.name == 'Cube003_7' ||
            child.name == 'Cube003_8' ||
            child.name == 'Cube003_9' ||
            child.name == 'Cube003_10'
        )) {
...
//This function will be used to rename the mesh Cube003_1 to Cube003_10 to Cube041 just to match the convention of this code.
...
function init() {
    ...
    loader.load( 'Color_Mesh.glb', function ( gltf ) {
        ...
        // I will then rename the mesh of library to match the convention of this code
        //rename(model);
        ...
        ////Cycle Instance (Random materials)
...
async function createInstances(geometry, material,loadTransforms) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // const hue = 0.16;              // Yellow
    // const saturation = 1;          // Full saturation
    // const lightness = 0.1 + Math.random() * 0.01;  
    // // from 0.4 (dark yellow) to 0.8 (light yellow)
