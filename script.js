...
document.querySelector(".back").addEventListener('click',()=>{
    ...
    // if(previuosly_selected_object){
    //     console.log(`And the name of previuosly selcted object is ${previuosly_selected_object.name}`);
    // }
    ...
    //Reset the Selected Object scale (All the objects)
    gsap.to(
    ...
    if ( intersects.length > 0 ) {
        ...
        if ( res && res.object ) {
            ...
            if(res.object.name != "Cube041")
            {
                ...
                console.log(`Selected Obejct : ${selectedObject.name}`);
                console.log(`Previously Selected Obejct : ${previuosly_selected_object.name}`);
                ...
                if(selectedObject.name == "GSAP1"){
                    ...
                    animate_Selection(selectedObject,0.5,1,-1.5);
